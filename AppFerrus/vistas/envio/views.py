...
class Envioslistview(ListView):
    ...
    @method_decorator(permission_required('AppFerrus.view_envios'))
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'searchdata':
                ...
                data = []
                for i in Detenvios.objects.filter(envios_id=request.POST['id']):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('enviocrear')
        context['list_url'] = reverse_lazy('enviolistado')
        return context
...
class EnviosCreateView(CreateView):
    ...
    @method_decorator(permission_required('AppFerrus.add_envios'))
    def dispatch(self, request, *args, **kwargs):
        return super().dispatch(request, *args, **kwargs)
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search_articulo': #la variable de mi form js
                ...
                envio.empleado_id = request.POST['empleado']
                envio.save()
    ...
    def get_context_data(self, **kwargs): 
        ...
        context['entity'] = 'ENvio' #titulo de la tabla y pestaña
        context['action'] = 'add'
        return context 
...
class envioUpdateView(UpdateView):
    ...
    template_name = 'envio/crearregistro.html' #direccion de la pagina que voy usar
    success_url = reverse_lazy('enviolista') #direccion hacia donde voy a redireccionar
    @method_decorator(permission_required('AppFerrus.change_envios'))
    def dispatch(self, request, *args, **kwargs):
        return super().dispatch(request, *args, **kwargs)
    ...
    def get_articulo_detalles(self): #para llamar mis productos
        ...
        try:
            for i in Detenvios.objects.filter(envios_id=self.get_object().id):
    ...
    def get_context_data(self, **kwargs): 
        ...
        context['entity'] = 'Envios' #titulo de la tabla y pestaña
        context['action'] = 'edit'
