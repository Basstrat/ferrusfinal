        ...
        columnDefs: [ //manejo de columnas
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/erp/orden_compra/editar/' + row.id + '/" class="btn btn-warning btn-sm">Editar</a> ';
                    buttons += '<a rel="details" class="btn btn-success btn-sm">Detalles</a> ';
                    buttons += '<a href="/erp/orden_compra/imprimir/'+row.id+'/" target="_blank" class="btn btn-info btn-sm">Imprimir</a> ';
                    return buttons;
                }
            },
        ],
